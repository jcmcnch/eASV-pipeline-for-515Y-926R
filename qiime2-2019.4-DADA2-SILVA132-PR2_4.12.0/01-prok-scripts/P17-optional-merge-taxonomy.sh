...
cut -f3- 10-exports/include_o__Chloroplast_filtered_table.with-tax.proportions.tsv | paste 17-taxonomy-lookup-table/chloroplasts/Chloroplasts-Lookup-Table.tsv - | sponge 17-taxonomy-lookup-table/chloroplasts/Chloroplasts-Lookup-Table.tsv
...
cut -f1,2 10-exports/exclude_o__Chloroplast_filtered_table.with-tax.proportions.tsv | sed '1s/taxonomy/taxonomy-SILVA138-default-point7/' > 17-taxonomy-lookup-table/non-chloroplasts/Non-Chloroplasts-Lookup-Table.tsv
