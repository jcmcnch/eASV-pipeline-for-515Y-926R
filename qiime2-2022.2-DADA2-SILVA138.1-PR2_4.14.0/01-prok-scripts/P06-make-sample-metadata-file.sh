...
#print headers
printf "sample-id	Example1_categorical_change_me	Example2_numeric_change_me" > sample-metadata.tsv
printf "#q2:types	categorical	numeric" >> sample-metadata.tsv

#get sample IDs from manifest file
cut -f1 manifest.tsv | tail -n+2 >> sample-metadata.tsv
