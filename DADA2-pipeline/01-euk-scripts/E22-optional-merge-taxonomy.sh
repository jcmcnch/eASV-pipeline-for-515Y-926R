...
for item in `ls 15-exports/*all-18S-seqs.with-SILVA132-tax.proportions.tsv`; do confidence=`basename $item | cut -d\- -f4` &&  cut -f2 $item | sed "1s/taxonomy/taxonomy-${confidence}-default-point7/" | paste 22-taxonomy-lookup-table/All-18S-Lookup-Table.tsv - | sponge 22-taxonomy-lookup-table/All-18S-Lookup-Table.tsv ; done

for item in `ls 20-exports/04-converted-biom-to-tsv/SILVA132/*point5-p-confidence-converted-biom.proportions.tsv`; do confidence=`basename $item | cut -d\- -f1,5` &&  cut -f2 $item | sed "1s/taxonomy/taxonomy-$confidence/" | paste 22-taxonomy-lookup-table/All-18S-Lookup-Table.tsv - | sponge 22-taxonomy-lookup-table/All-18S-Lookup-Table.tsv ; done


for item in `ls 20-exports/04-converted-biom-to-tsv/SILVA132/*point3-p-confidence-converted-biom.proportions.tsv`; do confidence=`basename $item | cut -d\- -f1,5` &&  cut -f2 $item | sed "1s/taxonomy/taxonomy-$confidence/" | paste 22-taxonomy-lookup-table/All-18S-Lookup-Table.tsv - | sponge 22-taxonomy-lookup-table/All-18S-Lookup-Table.tsv ; done

for item in `ls 20-exports/04-converted-biom-to-tsv/SILVA132/*minus1-p-confidence-converted-biom.proportions.tsv`; do confidence=`basename $item | cut -d\- -f1,5` &&  cut -f2 $item | sed "1s/taxonomy/taxonomy-$confidence/" | paste 22-taxonomy-lookup-table/All-18S-Lookup-Table.tsv - | sponge 22-taxonomy-lookup-table/All-18S-Lookup-Table.tsv ; done
