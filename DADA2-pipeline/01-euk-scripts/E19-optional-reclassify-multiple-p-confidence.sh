...
#Classify all the 18S sequences with SILVA 132 at the default [0.7] p-confidence level
...
qiime feature-classifier classify-sklearn \
  ...
  --o-classification 19-reclassified/SILVA132/SILVA132-All-18S-seqs-default-p-confidence-classification.qza
...
#Classify all the 18S sequences with PR2 at the default [0.7] p-confidence level

qiime feature-classifier classify-sklearn \
  --i-classifier /home/db/PR2/Oceanic_database/PR2/PR2_for_qiime2_515Y_926R_sliced_classifier.qza \
  --i-reads 08-DADA2d/representative_sequences.qza \
  --o-classification 19-reclassified/PR2/PR2-All-18S-seqs-default-p-confidence-classification.qza
